                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i>Tugas Akhir Kelompok 1 Bootcamp batch 3</li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: 60-49 Road 11378 Unilak</li>
                            <li>Phone: +6282371295050</li>
                            <li>Email: kelompok1.bootcamp.com</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="footer__copyright__text">
                            <p>
                               ...
                               Laravel Shop
                                ...
                                <a href="https://colorlib.com" target="_blank">Kelompok 1 BATCH 3</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
